...
<div class="flex items-center justify-center min-h-screen">
  <div class="bg-white shadow-lg rounded-2xl grid md:grid-cols-2 w-[850px] overflow-hidden">
    
    <!-- Left: Promo Section -->
    <div class="bg-blue-600 p-8 flex flex-col justify-center text-white">
      <h2 class="text-3xl font-bold mb-4">Welcome Back 👋</h2>
      <p class="mb-6">Login to explore toys, manage orders and enjoy exclusive offers.</p>
